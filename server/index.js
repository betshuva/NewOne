...
app.get('/api/admin/verify-demo', async (req, res) => {
  ...
  try {
    ...
    res.json({ ok: true, msg: 'demo@betshuva.com verified' });
  } catch (e) { res.status(500).json({ error: e.message }); }
});
...
app.get('/api/version', async (req, res) => {
  ...
  res.json({ version: '1.2.6', apkUrl: 'https://betshuva.com/app-release.apk' });
});
